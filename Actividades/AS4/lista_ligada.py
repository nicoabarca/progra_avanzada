...
class NodoAmigoSecreto: #esto es una lista ligada
    ...
    def insertar_amigo_secreto(self, nuevo_nodo, posicion,
        ...
        # Completar
        pass
        # nuevo = NodoAmigoSecreto(nuevo_nodo)
        # nodo_actual = NodoAmigoSecreto(self.siguiente)

        # if self.siguiente == self:


        # #caso en que posicion_actual y posicion sean 0
        # if posicion_actual == posicion: 
        #     nuevo_nodo.siguiente = self.usuario
